...
class NavigationController extends BaseController {
	...
	public function getNoticesPage()
	{
		...
		$campusdetails = $collegename.'/'.$campusname.'/'.$campusid;
		
		$campusdetails = strtolower($campusdetails);
		
		$campusdetails = str_replace(' ', '-', $campusdetails);
			
		return Redirect::route('campus-notice-get',$campusdetails);
	}
	
	public function getCampusNoticesPage($collegex,$campusx,$campusid)
	{
		$last_id=0;
		...
		if(Auth::user())
		return View::make('member.notice');
		return View::make('guest.notice');
	}
	//load more events
	public function getMoreNoticesPage($lastid)
	{
		$last_id=0;
		$campusid = $this->getDevice();
		$obj = new BaseController;
	...
	public function getEventsPage()
	{
		...
		return Redirect::route('campus-events-get',$campusdetails);
	}

	public function getCampusEventsPage($collegex,$campusx,$campusid)
	{
		$last_id=0;
		...
		$squeebs = Eventsq::whereHas('Squeeb',function($query) use($campusid)
							{	
							  	$query->where('branch_id','=',$campusid)->where('active','=',TRUE);
							})
							->orwhereHas('Squeeb',function($query)
		...
		//get the top squeeb to display
		$topsqueebs = Squeeb::where('active','=',TRUE)->where('model','=','Eventsq')->where('branch_id','=',$campusid)->orderBy('views','DESC')->take(self::TOP_SQUEEB_LIMIT)->get();
		View::share('topsqueebs',$topsqueebs);
		...
		if(Auth::user())
		return View::make('member.event');
		return View::make('guest.event');
	}
	//load more events
	public function getMoreEventsPage($lastid)
	{
		$last_id=0;
		$campusid = $this->getDevice();
		$obj = new BaseController;
		...
		$squeebs = Eventsq::whereHas('Squeeb',function($query) use($campusid,$lastid)
							{
							  $query->where('branch_id','=',$campusid)->where('id','<',$lastid)->where('active','=',TRUE);
							})
							->orwhereHas('Squeeb',function($query) use($lastid)
	...
	public function getOffersPage()
	{
		...
		return Redirect::route('campus-offers-get',$campusdetails);
	}
	
	
	public function getCampusOffersPage($collegex,$campusx,$campusid)
	{
		$last_id=0;
		...
		$squeebs = Offer::whereHas('Squeeb',function($query) use($campusid)
							{	
							  	$query->where('branch_id','=',$campusid)->where('active','=',TRUE);
							})
							->orwhereHas('Squeeb',function($query)
	...
	public function getJobsPage()
	{
		...
		return Redirect::route('campus-jobs-get',$campusdetails);
	}
	
	
	public function getCampusJobsPage($collegex,$campusx,$campusid)
	{
		$last_id=0;
		...
		$squeebs = Job::whereHas('Squeeb',function($query) use($campusid)
							{	
							  	$query->where('branch_id','=',$campusid)->where('active','=',TRUE);
							})
							->orwhereHas('Squeeb',function($query)
		...
		//get the top squeeb to display
		$topsqueebs = Squeeb::where('active','=',TRUE)->where('model','=','Job')->where('branch_id','=',$campusid)->orderBy('views','DESC')->take(self::TOP_SQUEEB_LIMIT)->get();
		View::share('topsqueebs',$topsqueebs);
		...
		if(Auth::user())
		return View::make('member.job');
		return View::make('guest.job');
	}
	//load more jobs
	public function getMoreJobsPage($lastid)
	{
		$last_id=0;
		$campusid = $this->getDevice();
		$obj = new BaseController;
		...
		$squeebs = Job::whereHas('Squeeb',function($query) use($campusid,$lastid)
							{
							  $query->where('branch_id','=',$campusid)->where('id','<',$lastid)->where('active','=',TRUE);
							})
							->orwhereHas('Squeeb',function($query) use($lastid)
	...
	{
		return View::make('guest.help');
	}
	public function getAdvencedSqueebPage()
	{
		return View::make('guest.advancedpostselection');
	}
	
	public function getAdvancedSqueebPostPage()
	{
		return View::make('guest.advancedpost');
	}
