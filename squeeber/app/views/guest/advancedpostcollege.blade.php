										...
										<div class="left-top-corner maxheight">
											<div class="right-top-corner maxheight">
												...
												<div class="inner">
													...
													<div class="post">
													<form name="post-form"  id="postf-form" enctype="multipart/form-data" method="post" action="{{URL::route('advanced_squeeb-post-data-college-2')}}" >
														...
														<input type="hidden" value="{{$collegeid}}" name="College" />
