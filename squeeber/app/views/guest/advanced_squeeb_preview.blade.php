										...
										<div class="left-top-corner maxheight">
											<div class="right-top-corner maxheight">
												...
												<div class="activatesqueeb">
													<form id="activatesqueeb-form" method="post" action="{{URL::route('advanced_squeeb-post-data-activate')}}" >
												
														
														<div class="field">
															<input style="float:left;margin-bottom:10px;" type="submit" value="Activate Squeeb"/>
															
															<input style="float:left;margin-bottom:10px;" type="button" onclick="history.go(-1)" value="Edit Squeeb" />
															{{Form::token()}}
											
														</div>
														<div style="display:none;">
															<input type="hidden" name="The_Squib_Array" id="The_Squib_Array" value="{{$the_squeeb_array}}" />
														</div>
													</form>													
												</div>	
