										...
										<div class="left-top-corner maxheight">
											<div class="right-top-corner maxheight">
												...
												<div class="inner">
													...
													<div class="post">
													<form name="post-form"  id="postf-form" enctype="multipart/form-data" method="post" action="{{URL::route('post-post')}}" >
														...
														<div align="center" class="signup_link">
															<a href="{{URL::route('advanced_squeeb-get')}}">Advanced Posting>></a> 
															<br /><br />
															<a href="{{URL::route('login-get')}}">Log In to manage your squeeb or add your college>></a>
														</div>
													</form>
