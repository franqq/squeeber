...
<html lang="en">
<head>
<title>The Squeeber | {{$college->name}} ({{$college->alias}}, {{$mycampus->name}} campus ) Notices, News, Events, Jobs, Internship, Classifieds</title>
<meta name="description" content="Get all the notices, gossips, events notification and any important notifications within your college. Put a notice anytime for free to be viewed by your colleagues at school...">
<meta name="keywords" content="squeeber, {{$college->alias}}, {{$mycampus->name}}, campus, notices in {{$college->name}}, gossip, careers, jobs, intenrships, university">
