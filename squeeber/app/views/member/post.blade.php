@extends('member.layouts.post_header')
@section('content')
									...
									<div class="border-left maxheight">
										<div class="left-top-corner maxheight">
											<div class="right-top-corner maxheight">
												...
												<h2 style="text-transform:capitalize;"><span>Post Free Squeeb</span>	
												</h2>
												...
												<div class="inner">
													...
													<div class="post">
													<form name="post-form"  id="postf-form" enctype="multipart/form-data" method="post" action="{{URL::route('member-post-post')}}" >
														...
														<div class="field">
														<label2><strong>Category <required>*<required></strong></label2>
																<select required="required" name="Typem">
															...
															@if($errors->has('Typem'))
															<p class="post_errors">* {{$errors->first('Typem')}}</p>
															@endif								
														...
														<div class="field">
																...
																<input required="required" placeholder="Enter A Short Title" maxlength="40" e{{(Input::old('Title')) ? ' value = ' .Input::old('Title'). '' : ''}} name="Title" type="text">
																@if($errors->has('Title'))
														...
														<div class="field">
																...
																<textarea rows="2" name="Description" placeholder="Enter your text here.. " required="required" cols="20" style="" >@if(Input::old('Description')){{Input::old('Description')}}@endif</textarea>
